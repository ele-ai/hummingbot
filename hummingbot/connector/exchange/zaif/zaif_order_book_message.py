...
class ZaifOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(ZaifOrderBookMessage, cls).__new__(
    ...
    def asks(self) -> List[OrderBookRow]:
        # raise NotImplementedError("Zaif order book messages have different semantics.")
        return [
